...
namespace Allure.Xunit.StepAttribute
{
    public abstract class AllureStepAttributeBase : OnMethodBoundaryAspect
    {
        ...
        public override void OnExit(MethodExecutionArgs arg)
        {
            ...
            {
                AllureXunitHelper.PassStep((ExecutableItem) arg.MethodExecutionTag);
                return;
            }
        ...
        public override void OnException(MethodExecutionArgs arg) =>
            AllureXunitHelper.FailStep((ExecutableItem) arg.MethodExecutionTag);
        ...
        public static void ContinueTaskGeneric<T>(MethodExecutionArgs args)
        {
            ...
            {
                AllureXunitHelper.PassStep((ExecutableItem) args.MethodExecutionTag);
                return task.Result;
        ...
        public static void ContinueTask(MethodExecutionArgs args)
        {
            ...
            returnValue.ContinueWith(_ => AllureXunitHelper.PassStep((ExecutableItem) args.MethodExecutionTag),
                TaskContinuationOptions.OnlyOnRanToCompletion | TaskContinuationOptions.ExecuteSynchronously);
        }
    }
}